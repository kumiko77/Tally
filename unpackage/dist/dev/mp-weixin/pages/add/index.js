...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/add/index.vue */ 49));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_65a9288a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=65a9288a& */ 50);
...
var components = {
  ...
  uKeyboard: function() {
    return __webpack_require__.e(/*! import() | uview-ui/components/u-keyboard/u-keyboard */ "uview-ui/components/u-keyboard/u-keyboard").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-keyboard/u-keyboard.vue */ 92))
  },
  uTabbar: function() {
...
var _default = { data: function data() {return { list: [{ name: '支出' }, { name: '收入' }], typeList: [], current: 0, typeActive: '999', typeActiveEngName: '', typeActiveName: '', isOut: true, show: false };}, mounted: function mounted() {this.typeList = _type.default.data;}, watch: { show: function show() {if (!this.show) {this.typeActive = '999';}}, current: function current() {this.current === 0 ? this.isOut = true : this.isOut = false;} }, methods: { change: function change(index) {this.current = index;}, menuItemClick: function menuItemClick(data, index) {this.typeActive = index;this.typeActiveEngName = data.type;this.typeActiveName = data.typeName;this.show = true;this.$refs.uKeyboard.open();
    ...
    save: function save(val) {
      ...
      this.$uniCloud('saveAccount', obj).then(function (res) {
        uni.switchTab({
          url: '../detail/index' });
